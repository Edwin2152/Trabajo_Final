...
izquierda=dbc.Container([
    dbc.Row([
        ...
        dcc.Dropdown(['Marca 1','Marca 2', 'Marca 3'],value='Marca 1',id="Modelo_consultado"),
        dbc.Col(html.H2("Seleccione la referencia"), md=12, style={'background-color': '#155F82','margin-top':'15px'}),
        dcc.Dropdown(['Referencia 1','Referencia 2', 'Referencia 3'],value='Referencia 1',id="Referencia_consultado"),
        dbc.Col(html.H2("Seleccione el modelo"), md=12, style={'background-color': '#155F82','margin-top':'15px'}),
        dcc.Dropdown(['Modelo 1','Modelo 2', 'Modelo 3'],value='Modelo 1',id="Marca_consultado"),
    ])    
])